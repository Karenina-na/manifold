export type ContentKind = "TECH" | "THOUGHT" | "MANUSCRIPT";
...
export interface TechMetadata { technologies: string[]; language?: string; difficulty?: "BEGINNER" | "INTERMEDIATE" | "ADVANCED"; repositoryUrl?: string }
export interface ThoughtMetadata { mood?: string; question?: string; context?: string }
export interface ManuscriptMetadata { form: "ESSAY" | "STORY" | "BOOK" | "OTHER"; stage: "IDEA" | "DRAFT" | "REVISION" | "FINAL"; wordCount?: number }
export type ContentMetadata = TechMetadata | ThoughtMetadata | ManuscriptMetadata
...
export type Content = ContentWithMetadata<TechMetadata, "TECH"> | ContentWithMetadata<ThoughtMetadata, "THOUGHT"> | ContentWithMetadata<ManuscriptMetadata, "MANUSCRIPT">
export type ContentDetail = ContentDetailWithMetadata<TechMetadata, "TECH"> | ContentDetailWithMetadata<ThoughtMetadata, "THOUGHT"> | ContentDetailWithMetadata<ManuscriptMetadata, "MANUSCRIPT">
...
export interface Stats { contentCount: number; techCount: number; thoughtCount: number; manuscriptCount: number; wordCount: number; updatedAt: string }
...
interface BaseContentInput { slug: string; title: string; summary: string; body: string; tags: string[] }
export type ContentInput =
  | (BaseContentInput & { kind: "TECH"; metadata: TechMetadata })
  | (BaseContentInput & { kind: "THOUGHT"; metadata: ThoughtMetadata })
  | (BaseContentInput & { kind: "MANUSCRIPT"; metadata: ManuscriptMetadata })
export interface UpdateContentInput { title?: string; summary?: string; body?: string; tags?: string[]; metadata?: ContentMetadata; expectedVersion: number }
