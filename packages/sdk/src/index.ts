...
export class ManifoldClient {
	...
	compactAgentMessages() { return this.request<AgentCompactionResult>("/api/v1/admin/agent/messages/compact", { method: "POST" }); }
