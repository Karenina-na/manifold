...
function metadataFrom(form: Form): ContentInput['metadata'] {
  ...
  if (form.readingMinutes !== undefined && !Number.isNaN(form.readingMinutes)) metadata.readingMinutes = form.readingMinutes
