...
export function ArticleLightbox() {
  ...
  return (
    <div ref={dialogRef} className={styles.lightbox} role="dialog" aria-modal="true" aria-label={alt || t("lightbox.preview")} onClick={close}>
      <button type="button" ref={closeRef} className={styles.lightboxClose} onClick={close} aria-label={t("lightbox.close")}>
