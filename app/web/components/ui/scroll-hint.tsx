...
export function ScrollHint({ targetRef, manual }: ScrollHintProps) {
  ...
  return <button type="button" className={styles.scrollHint} data-fading={phase === "fading"} aria-label={t("archive.scrollToList")} onClick={() => window.scrollBy({ top: Math.round(window.innerHeight * 0.9), behavior: "smooth" })}>
