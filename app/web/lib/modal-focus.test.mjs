...
test("every modal surface routes through the shared focus boundary", () => {
  for (const path of ["../components/article-lightbox.tsx", "../components/site-nav.tsx"]) {
  ...
  const tooltip = readFileSync(new URL("../components/floating-tooltip.tsx", import.meta.url), "utf8");
